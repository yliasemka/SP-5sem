// Sp6.cpp : Определяет точку входа для приложения.
//
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_SP6, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SP6));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SP6));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        hStop = CreateWindow(L"button", L"Stop",
            WS_CHILD | WS_VISIBLE |
            BS_PUSHBUTTON,
            100, 300, 200, 50, hWnd, (HMENU)IDB_STOP, hInst, NULL);
        ...
        PARAMS* p4 = new PARAMS{ hWnd, static_cast<unsigned int>(400) };
        ...
        hThread4 = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)drawRectangle, (LPVOID*)p4, CREATE_SUSPENDED, (LPDWORD)&THREAD_ID_4);
    }
    break;
    case WM_COMMAND:
    {
