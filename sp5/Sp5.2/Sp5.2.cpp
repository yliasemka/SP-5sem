// Sp5.2.cpp : Определяет точку входа для приложения.
//
...
WCHAR szTitle[MAX_LOADSTRING] = L"Second";                  // The title bar text
WCHAR szWindowClass[MAX_LOADSTRING] = L"SECOND";            // the main window class name
    ...
    _In_ int       nCmdShow)
{
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SP52));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SP52));
